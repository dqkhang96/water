...
export interface deleteCustomer { type: ActionTypes.DELETE_CUSTOMER, payload: string }
export const deleteCustomer = (customerId: string) => action(ActionTypes.DELETE_CUSTOMER, customerId)
